...
#include "CGLXPawn.h"
#include "CGLXWheelFront.h"
#include "CGLXWheelRear.h"
#include "CGLXHud.h"
...
const FName ACGLXPawn::LookUpBinding("LookUp");
const FName ACGLXPawn::LookRightBinding("LookRight");
const FName ACGLXPawn::EngineAudioRPM("RPM");
...
ACGLXPawn::ACGLXPawn()
{
	...
	// Wheels/Tyres
	// Setup the wheels
	Vehicle4W->WheelSetups[0].WheelClass = UCGLXWheelFront::StaticClass();
	Vehicle4W->WheelSetups[0].BoneName = FName("PhysWheel_FL");
	Vehicle4W->WheelSetups[0].AdditionalOffset = FVector(0.f, -8.f, 0.f);

	Vehicle4W->WheelSetups[1].WheelClass = UCGLXWheelFront::StaticClass();
	Vehicle4W->WheelSetups[1].BoneName = FName("PhysWheel_FR");
	Vehicle4W->WheelSetups[1].AdditionalOffset = FVector(0.f, 8.f, 0.f);

	Vehicle4W->WheelSetups[2].WheelClass = UCGLXWheelRear::StaticClass();
	Vehicle4W->WheelSetups[2].BoneName = FName("PhysWheel_BL");
	Vehicle4W->WheelSetups[2].AdditionalOffset = FVector(0.f, -8.f, 0.f);

	Vehicle4W->WheelSetups[3].WheelClass = UCGLXWheelRear::StaticClass();
...
void ACGLXPawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &ACGLXPawn::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &ACGLXPawn::MoveRight);
	PlayerInputComponent->BindAxis(LookUpBinding);
	PlayerInputComponent->BindAxis(LookRightBinding);

	PlayerInputComponent->BindAction("Handbrake", IE_Pressed, this, &ACGLXPawn::OnHandbrakePressed);
	PlayerInputComponent->BindAction("Handbrake", IE_Released, this, &ACGLXPawn::OnHandbrakeReleased);
	PlayerInputComponent->BindAction("SwitchCamera", IE_Pressed, this, &ACGLXPawn::OnToggleCamera);

	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ACGLXPawn::OnResetVR); 
}

void ACGLXPawn::MoveForward(float Val)
{
	GetVehicleMovementComponent()->SetThrottleInput(Val);

}

void ACGLXPawn::MoveRight(float Val)
{
	GetVehicleMovementComponent()->SetSteeringInput(Val);
}

void ACGLXPawn::OnHandbrakePressed()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(true);
}

void ACGLXPawn::OnHandbrakeReleased()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(false);
}

void ACGLXPawn::OnToggleCamera()
{
	EnableIncarView(!bInCarCameraActive);
}

void ACGLXPawn::EnableIncarView(const bool bState)
{
...
void ACGLXPawn::Tick(float Delta)
{
	Super::Tick(Delta);
...
void ACGLXPawn::UpdateHUDStrings()
{
...
void ACGLXPawn::UpdatePhysicsMaterial()
{
